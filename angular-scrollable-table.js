            ...
            return {
                ...
                controller: ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
                    ...
                    function fixHeaderWidths() {
                        ...
                        if (!$element.find("tfoot th .th-innerb").length) {
                            $element.find("tfoot th").wrapInner('<div class="th-innerb"></div>');
                        }
                        if ($element.find("tfoot th .th-innerb:not(:has(.box))").length) {
                            $element.find("tfoot th .th-innerb:not(:has(.box))").wrapInner('<div class="box"></div>');
                        }
                    ...
                    var footerElementToFakeScroll = isFirefox ? "tfoot" : "tfoot th .th-inner";
                    ...
                    $element.find(".scrollArea").on("scroll", function (event) {
                        ...
                        $element.find(footerElementToFakeScroll).css('margin-left', 0 - event.target.scrollLeft);
                    });
